...
public class UsersController {
	...
	//5 "/signin.do" 로그인 요청처리
	@RequestMapping("/signin")
	public ModelAndView signin(@ModelAttribute UsersDto dto, HttpSession session){
		System.out.println("controller-id:"+dto.getId()+"   signid"+dto.getSignid());
		System.out.println("controller pwd:  "+dto.getPwd());
		...
		if(isValid){	//아이디 비밀 번호가 맞는 정보인 경우
			//로그인 처리를 해준다.
			session.setAttribute("id", dto.getSignid());
